...
\restrict atr6yGiSdQmd7zIZyBWdFTPpHxJxYFrX44JJfbIA0XdqRsiRp9MODB59wVJHxSj
...
--
-- Name: admin_approve_global_image(uuid, text, text, text); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.admin_approve_global_image(p_global_catalog_id uuid, p_new_name text DEFAULT NULL::text, p_new_barcode text DEFAULT NULL::text, p_status text DEFAULT 'approved'::text) RETURNS void
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
BEGIN
...
ALTER FUNCTION public.admin_approve_global_image(p_global_catalog_id uuid, p_new_name text, p_new_barcode text, p_status text) OWNER TO postgres;

--
-- Name: complete_pos_checkout(uuid, uuid, jsonb, numeric, text, numeric, boolean, uuid); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.complete_pos_checkout(p_tenant_id uuid, p_customer_id uuid, p_items jsonb, p_discount_percent numeric DEFAULT 0, p_payment_method text DEFAULT NULL::text, p_cash_received numeric DEFAULT NULL::numeric, p_is_credit_sale boolean DEFAULT false, p_location_id uuid DEFAULT '00000000-0000-0000-0000-000000000001'::uuid) RETURNS jsonb
    LANGUAGE plpgsql SECURITY DEFINER
...
BEGIN
  ...
  LOOP
    ...
    SELECT pv.id, pv.sku, pv.price_ars, COALESCE(p.title, p.nombre, 'Sin nombre') AS title
    INTO v_variant
    ...
    WHERE tenant_id = p_tenant_id AND variant_id = v_variant_id AND location_id = p_location_id
    FOR UPDATE;
  ...
  LOOP
    ...
    WHERE tenant_id = p_tenant_id AND variant_id = (v_item ->> 'variant_id')::uuid AND location_id = p_location_id;
  END LOOP;
  ...
  IF NOT p_is_credit_sale THEN
    ...
    INSERT INTO payments (
      tenant_id, order_id, gateway, status, amount_ars, currency, method, processed_at
    ) VALUES (
      p_tenant_id, v_order_id, v_gateway, 'paid', v_total, 'ARS', p_payment_method, now()
    );
  END IF;
...
ALTER FUNCTION public.complete_pos_checkout(p_tenant_id uuid, p_customer_id uuid, p_items jsonb, p_discount_percent numeric, p_payment_method text, p_cash_received numeric, p_is_credit_sale boolean, p_location_id uuid) OWNER TO postgres;

--
-- Name: complete_pos_checkout_rpc(jsonb); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.complete_pos_checkout_rpc(p jsonb) RETURNS jsonb
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
declare
...
ALTER FUNCTION public.complete_pos_checkout_rpc(p jsonb) OWNER TO postgres;
...
--
-- Name: find_global_image(text, text); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.find_global_image(p_barcode text DEFAULT NULL::text, p_product_name text DEFAULT NULL::text) RETURNS TABLE(id uuid, cloudinary_url text, normalized_name text, quality_score numeric, match_type text)
...
ALTER FUNCTION public.find_global_image(p_barcode text, p_product_name text) OWNER TO postgres;

--
-- Name: get_product_image(uuid, uuid, text); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.get_product_image(p_tenant_id uuid, p_global_catalog_id uuid, p_tenant_override text) RETURNS text
    LANGUAGE plpgsql STABLE
    AS $$
BEGIN
...
ALTER FUNCTION public.get_product_image(p_tenant_id uuid, p_global_catalog_id uuid, p_tenant_override text) OWNER TO postgres;

--
-- Name: increment_ml_clicks(text, uuid); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.increment_ml_clicks(p_item_id text, p_tenant_id uuid) RETURNS void
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
BEGIN
  UPDATE ml_products
...
--
-- Name: reserve_stock(uuid, integer, uuid, integer); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.reserve_stock(p_variant_id uuid, p_quantity integer, p_cart_id uuid, p_ttl_minutes integer DEFAULT 15) RETURNS json
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
declare
  v_inventory inventory_levels%rowtype;
...
ALTER FUNCTION public.reserve_stock(p_variant_id uuid, p_quantity integer, p_cart_id uuid, p_ttl_minutes integer) OWNER TO postgres;
...
--
-- Name: global_catalog; Type: TABLE; Schema: public; Owner: postgres
--
...
CREATE TABLE public.global_catalog (
    ...
    CONSTRAINT global_catalog_status_check CHECK ((status = ANY (ARRAY['pending'::text, 'approved'::text, 'rejected'::text, 'featured'::text])))
);
...
CREATE TABLE public.inventory_levels (
    ...
    location_id uuid DEFAULT '00000000-0000-0000-0000-000000000001'::uuid NOT NULL,
...
CREATE VIEW public.inventory_items AS
 SELECT extensions.uuid_generate_v5('00000000-0000-0000-0000-000000000000'::uuid, (((((tenant_id)::text || ':'::text) || (variant_id)::text) || ':'::text) || (location_id)::text)) AS id,
    tenant_id,
    variant_id,
    location_id,
...
--
-- Name: ml_clicks_log; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.ml_clicks_log (
    id uuid DEFAULT extensions.uuid_generate_v4() NOT NULL,
    tenant_id uuid NOT NULL,
...
--
-- Name: ml_products; Type: TABLE; Schema: public; Owner: postgres
--
...
CREATE TABLE public.order_items (
    ...
    unit_price_ars numeric DEFAULT 0 NOT NULL,
    unit_price numeric DEFAULT 0 NOT NULL,
    tax_ars numeric DEFAULT 0 NOT NULL,
    tax_rate numeric DEFAULT 0.21 NOT NULL,
    title_snapshot text,
    sku_snapshot text,
    created_at timestamp with time zone DEFAULT now() NOT NULL
);
...
CREATE TABLE public.orders (
    ...
    status text DEFAULT 'pending'::text NOT NULL,
    financial_status text DEFAULT 'pending'::text NOT NULL,
    fulfillment_status text DEFAULT 'unfulfilled'::text,
    subtotal_ars numeric DEFAULT 0 NOT NULL,
    tax_ars numeric DEFAULT 0 NOT NULL,
    total_ars numeric DEFAULT 0 NOT NULL,
    ...
    notes text,
    payment_method text,
    CONSTRAINT orders_channel_check CHECK ((channel = ANY (ARRAY['pos'::text, 'online'::text])))
);
...
CREATE TABLE public.payments (
    ...
    tenant_id uuid NOT NULL,
    order_id uuid NOT NULL,
    gateway text DEFAULT 'cash'::text NOT NULL,
    status text DEFAULT 'pending'::text NOT NULL,
    amount_ars numeric DEFAULT 0 NOT NULL,
    currency text DEFAULT 'ARS'::text NOT NULL,
    method text,
...
CREATE TABLE public.plans (
    ...
    precio_mensual numeric DEFAULT 0 NOT NULL,
...
--
-- Name: product_attribute_assignments; Type: TABLE; Schema: public; Owner: postgres
--
...
CREATE TABLE public.product_attributes (
    ...
    name text NOT NULL,
    slug text NOT NULL,
    type text DEFAULT 'select'::text NOT NULL,
...
--
-- Name: product_global_refs; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.product_global_refs (
    id uuid DEFAULT extensions.uuid_generate_v4() NOT NULL,
    tenant_id uuid NOT NULL,
    global_catalog_id uuid,
    ref_type text DEFAULT 'direct'::text NOT NULL,
    matched_by text,
    match_confidence numeric,
    tenant_image_override text,
    contribution_status text DEFAULT 'none'::text,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT product_global_refs_contribution_status_check CHECK ((contribution_status = ANY (ARRAY['none'::text, 'pending'::text, 'approved'::text, 'rejected'::text]))),
    CONSTRAINT product_global_refs_ref_type_check CHECK ((ref_type = ANY (ARRAY['direct'::text, 'contribution'::text])))
);
...
CREATE TABLE public.product_variants (
    ...
    price_ars numeric DEFAULT 0 NOT NULL,
    requires_shipping boolean DEFAULT true NOT NULL,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    global_catalog_id uuid,
    use_global_image boolean DEFAULT false,
    tenant_image_override text,
    available_online boolean DEFAULT false,
    online_reserved integer DEFAULT 0,
...
CREATE TABLE public.stock_movements (
    ...
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    created_by uuid,
    CONSTRAINT stock_movements_channel_check CHECK ((channel = ANY (ARRAY['pos'::text, 'online'::text, 'internal'::text]))),
    CONSTRAINT stock_movements_type_check CHECK ((type = ANY (ARRAY['in'::text, 'out'::text, 'adjustment'::text, 'sale'::text, 'return'::text])))
);
...
CREATE TABLE public.stock_reservations (
    ...
    expires_at timestamp with time zone NOT NULL,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT stock_reservations_channel_check CHECK ((channel = ANY (ARRAY['pos'::text, 'online'::text])))
);
...
CREATE TABLE public.tenant_members (
    ...
    role text NOT NULL,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT tenant_members_role_check CHECK ((role = ANY (ARRAY['owner'::text, 'admin'::text, 'cashier'::text, 'viewer'::text])))
);
...
CREATE TABLE public.tenants (
    ...
    status text DEFAULT 'active'::text NOT NULL,
    plan_id uuid,
    online_store_enabled boolean DEFAULT false NOT NULL,
    custom_domain text,
    domain text,
    ...
    store_theme character varying(50) DEFAULT 'violet'::character varying,
    store_domain character varying(255),
    store_logo_url text,
    store_banner_url text,
    store_social_instagram character varying(255),
    store_social_facebook character varying(255),
    store_social_whatsapp character varying(255),
    store_currency character varying(10) DEFAULT 'ARS'::character varying,
    store_min_order_amount integer DEFAULT 0,
    store_shipping_enabled boolean DEFAULT true,
    store_shipping_free_threshold integer,
    store_shipping_cost integer DEFAULT 0,
    store_active boolean DEFAULT false,
    store_payment_methods jsonb,
    custom_domain_verified boolean DEFAULT false,
    custom_domain_cname character varying(255),
    store_template character varying(50) DEFAULT 'classic'::character varying,
    store_tagline character varying(255),
    store_banners jsonb DEFAULT '[]'::jsonb,
    store_appearance jsonb,
...
--
-- Name: global_catalog global_catalog_barcode_ean13_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.global_catalog
    ADD CONSTRAINT global_catalog_barcode_ean13_key UNIQUE (barcode_ean13);


--
-- Name: global_catalog global_catalog_normalized_slug_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.global_catalog
    ADD CONSTRAINT global_catalog_normalized_slug_key UNIQUE (normalized_slug);


--
-- Name: global_catalog global_catalog_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
ALTER TABLE ONLY public.inventory_levels
    ADD CONSTRAINT inventory_levels_pkey PRIMARY KEY (tenant_id, variant_id, location_id);


--
-- Name: ml_clicks_log ml_clicks_log_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: ml_products ml_products_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: ml_products ml_products_tenant_id_ml_item_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: orders orders_tenant_id_number_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.orders
    ADD CONSTRAINT orders_tenant_id_number_key UNIQUE (tenant_id, number);
...
--
-- Name: platform_config platform_config_key_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: product_attribute_assignments product_attribute_assignments_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: product_attribute_assignments product_attribute_assignments_product_id_attribute_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.product_attribute_assignments
    ADD CONSTRAINT product_attribute_assignments_product_id_attribute_id_key UNIQUE (product_id, attribute_id);


--
-- Name: product_attribute_options product_attribute_options_attribute_id_slug_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.product_attribute_options
    ADD CONSTRAINT product_attribute_options_attribute_id_slug_key UNIQUE (attribute_id, slug);
...
--
-- Name: product_attributes product_attributes_tenant_id_slug_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.product_attributes
    ADD CONSTRAINT product_attributes_tenant_id_slug_key UNIQUE (tenant_id, slug);


--
-- Name: product_global_refs product_global_refs_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: product_global_refs product_global_refs_tenant_id_global_catalog_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.product_global_refs
    ADD CONSTRAINT product_global_refs_tenant_id_global_catalog_id_key UNIQUE (tenant_id, global_catalog_id);
...
--
-- Name: products products_tenant_id_slug_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: customers_tenant_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: global_catalog_barcode_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX global_catalog_barcode_idx ON public.global_catalog USING btree (barcode_ean13);


--
-- Name: global_catalog_brand_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX global_catalog_brand_idx ON public.global_catalog USING btree (brand);


--
-- Name: global_catalog_name_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX global_catalog_name_idx ON public.global_catalog USING btree (normalized_name);


--
-- Name: global_catalog_name_trgm_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX global_catalog_name_trgm_idx ON public.global_catalog USING gin (normalized_name public.gin_trgm_ops);


--
-- Name: global_catalog_slug_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX global_catalog_slug_idx ON public.global_catalog USING btree (normalized_slug);


--
-- Name: global_catalog_status_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX global_catalog_status_idx ON public.global_catalog USING btree (status);
...
--
-- Name: ml_clicks_log_date_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX ml_clicks_log_date_idx ON public.ml_clicks_log USING btree (clicked_at DESC);


--
-- Name: ml_clicks_log_item_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX ml_clicks_log_item_idx ON public.ml_clicks_log USING btree (ml_item_id);


--
-- Name: ml_clicks_log_tenant_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX ml_clicks_log_tenant_idx ON public.ml_clicks_log USING btree (tenant_id);


--
-- Name: ml_products_item_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX ml_products_item_idx ON public.ml_products USING btree (ml_item_id);


--
-- Name: ml_products_tenant_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX ml_products_tenant_idx ON public.ml_products USING btree (tenant_id);
...
--
-- Name: orders_tenant_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: product_attribute_options_attribute_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX product_attribute_options_attribute_idx ON public.product_attribute_options USING btree (attribute_id);


--
-- Name: product_attributes_tenant_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX product_attributes_tenant_idx ON public.product_attributes USING btree (tenant_id);


--
-- Name: product_global_refs_global_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX product_global_refs_global_idx ON public.product_global_refs USING btree (global_catalog_id);


--
-- Name: product_global_refs_tenant_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX product_global_refs_tenant_idx ON public.product_global_refs USING btree (tenant_id);


--
-- Name: product_variants_global_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX product_variants_global_idx ON public.product_variants USING btree (global_catalog_id);


--
-- Name: product_variants_tenant_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX product_variants_tenant_idx ON public.product_variants USING btree (tenant_id);


--
-- Name: products_tenant_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: global_catalog global_catalog_contributed_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.global_catalog
    ADD CONSTRAINT global_catalog_contributed_by_fkey FOREIGN KEY (contributed_by) REFERENCES auth.users(id);


--
-- Name: inventory_levels inventory_levels_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: inventory_levels inventory_levels_variant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: ml_clicks_log ml_clicks_log_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: ml_products ml_products_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: product_attribute_assignments product_attribute_assignments_attribute_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: product_attribute_assignments product_attribute_assignments_product_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: product_attributes product_attributes_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: product_global_refs product_global_refs_global_catalog_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.product_global_refs
    ADD CONSTRAINT product_global_refs_global_catalog_id_fkey FOREIGN KEY (global_catalog_id) REFERENCES public.global_catalog(id) ON DELETE SET NULL;


--
-- Name: product_global_refs product_global_refs_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: product_variants product_variants_global_catalog_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.product_variants
    ADD CONSTRAINT product_variants_global_catalog_id_fkey FOREIGN KEY (global_catalog_id) REFERENCES public.global_catalog(id) ON DELETE SET NULL;
...
--
-- Name: product_variants product_variants_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: stock_reservations stock_reservations_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: subscription_payments subscription_payments_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: platform_settings Allow service_role full access to platform_settings; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Allow service_role full access to platform_settings" ON public.platform_settings USING (true) WITH CHECK (true);


--
-- Name: global_catalog; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.global_catalog ENABLE ROW LEVEL SECURITY;

--
-- Name: global_catalog global_catalog_admin_manage; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY global_catalog_admin_manage ON public.global_catalog USING (public.is_platform_admin());


--
-- Name: global_catalog global_catalog_contribute; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY global_catalog_contribute ON public.global_catalog FOR INSERT WITH CHECK ((auth.uid() IS NOT NULL));


--
-- Name: global_catalog global_catalog_public_read; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY global_catalog_public_read ON public.global_catalog FOR SELECT USING ((status = ANY (ARRAY['approved'::text, 'featured'::text])));


--
-- Name: product_global_refs; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.product_global_refs ENABLE ROW LEVEL SECURITY;

--
-- Name: product_global_refs product_global_refs_tenant_access; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY product_global_refs_tenant_access ON public.product_global_refs USING ((public.is_platform_admin() OR (tenant_id = public.current_tenant_id()))) WITH CHECK ((public.is_platform_admin() OR (tenant_id = public.current_tenant_id())));
...
--
-- Name: FUNCTION admin_approve_global_image(p_global_catalog_id uuid, p_new_name text, p_new_barcode text, p_status text); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.admin_approve_global_image(p_global_catalog_id uuid, p_new_name text, p_new_barcode text, p_status text) TO anon;
GRANT ALL ON FUNCTION public.admin_approve_global_image(p_global_catalog_id uuid, p_new_name text, p_new_barcode text, p_status text) TO authenticated;
GRANT ALL ON FUNCTION public.admin_approve_global_image(p_global_catalog_id uuid, p_new_name text, p_new_barcode text, p_status text) TO service_role;


--
-- Name: FUNCTION complete_pos_checkout(p_tenant_id uuid, p_customer_id uuid, p_items jsonb, p_discount_percent numeric, p_payment_method text, p_cash_received numeric, p_is_credit_sale boolean, p_location_id uuid); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.complete_pos_checkout(p_tenant_id uuid, p_customer_id uuid, p_items jsonb, p_discount_percent numeric, p_payment_method text, p_cash_received numeric, p_is_credit_sale boolean, p_location_id uuid) TO anon;
GRANT ALL ON FUNCTION public.complete_pos_checkout(p_tenant_id uuid, p_customer_id uuid, p_items jsonb, p_discount_percent numeric, p_payment_method text, p_cash_received numeric, p_is_credit_sale boolean, p_location_id uuid) TO authenticated;
GRANT ALL ON FUNCTION public.complete_pos_checkout(p_tenant_id uuid, p_customer_id uuid, p_items jsonb, p_discount_percent numeric, p_payment_method text, p_cash_received numeric, p_is_credit_sale boolean, p_location_id uuid) TO service_role;


--
-- Name: FUNCTION complete_pos_checkout_rpc(p jsonb); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.complete_pos_checkout_rpc(p jsonb) TO anon;
GRANT ALL ON FUNCTION public.complete_pos_checkout_rpc(p jsonb) TO authenticated;
GRANT ALL ON FUNCTION public.complete_pos_checkout_rpc(p jsonb) TO service_role;
...
--
-- Name: FUNCTION find_global_image(p_barcode text, p_product_name text); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.find_global_image(p_barcode text, p_product_name text) TO anon;
GRANT ALL ON FUNCTION public.find_global_image(p_barcode text, p_product_name text) TO authenticated;
GRANT ALL ON FUNCTION public.find_global_image(p_barcode text, p_product_name text) TO service_role;


--
-- Name: FUNCTION get_product_image(p_tenant_id uuid, p_global_catalog_id uuid, p_tenant_override text); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.get_product_image(p_tenant_id uuid, p_global_catalog_id uuid, p_tenant_override text) TO anon;
GRANT ALL ON FUNCTION public.get_product_image(p_tenant_id uuid, p_global_catalog_id uuid, p_tenant_override text) TO authenticated;
GRANT ALL ON FUNCTION public.get_product_image(p_tenant_id uuid, p_global_catalog_id uuid, p_tenant_override text) TO service_role;
...
--
-- Name: FUNCTION increment_ml_clicks(p_item_id text, p_tenant_id uuid); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION normalize_text(input_text text); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION reserve_stock(p_variant_id uuid, p_quantity integer, p_cart_id uuid, p_ttl_minutes integer); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.reserve_stock(p_variant_id uuid, p_quantity integer, p_cart_id uuid, p_ttl_minutes integer) TO anon;
GRANT ALL ON FUNCTION public.reserve_stock(p_variant_id uuid, p_quantity integer, p_cart_id uuid, p_ttl_minutes integer) TO authenticated;
GRANT ALL ON FUNCTION public.reserve_stock(p_variant_id uuid, p_quantity integer, p_cart_id uuid, p_ttl_minutes integer) TO service_role;
...
--
-- Name: TABLE global_catalog; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE ml_clicks_log; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE ml_products; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE product_attribute_assignments; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE product_global_refs; Type: ACL; Schema: public; Owner: postgres
--
...
\unrestrict atr6yGiSdQmd7zIZyBWdFTPpHxJxYFrX44JJfbIA0XdqRsiRp9MODB59wVJHxSj
