  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed right-4 bottom-24 lg:bottom-8 lg:right-8 z-[60] w-14 h-14 bg-violet-600 hover:bg-violet-500 hover:scale-110 active:scale-95 text-white rounded-full flex items-center justify-center shadow-[0_10px_30px_rgba(109,40,217,0.5)] transition-all duration-300 border border-violet-400/30"
      ...
      {isOpen && (
        <div className="fixed right-4 bottom-40 lg:bottom-24 lg:right-8 w-[92%] max-w-sm h-[480px] bg-zinc-900/95 border border-white/10 backdrop-blur-md text-white rounded-3xl shadow-[0_20px_50px_rgba(0,0,0,0.8)] z-[70] flex flex-col font-inter overflow-hidden animate-in fade-in slide-in-from-bottom-5 duration-200">
